...
public class Orders_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8002/itc/services/ordersSOAP?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8002/itc/services/ordersSOAP?wsdl");
        }
        WSDL_LOCATION = url;
    }
